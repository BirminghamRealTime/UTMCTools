...
This is an initial set of tools for accessing Birmingham City Council (BCC) opendata made available at [http://butc.opendata.onl/AL_opendata] (http://butc.opendata.only/AL_opendata)
